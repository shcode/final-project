            ...
            <div class="row-fluid">
                <form class="reg-page">
                    ...
                    <div class="controls">
                        ...
                        <input type="text" class="span12">
                        <label>Alamat</label>
                        <textarea class="span12" style="resize:vertical"></textarea>
                    </div>
                    <hr>
                    <div class="controls">
                    ...
                    <div class="controls form-inline">
                        ...
                        <button type="submit" class="btn-u pull-right">Register</button>
                    </div>
                    <hr>                    
                    <a class="btn btn-primary btn-block" type="button" id="sign-in-facebook">
                    ...
                    <hr>                    
                    <hr>
                    <p>Sudah pernah mendaftar? Klik <a class="color-green" href="{{rootUrl}login">login</a> untuk masuk.</p>
                </form>
            </div><!--/row-fluid-->
        </div>
